...
function doCanvas() {
    ...
    img.onload = function (){
        ctx.drawImage(img, 0, 0, img.width * 1, img.height * 0.8, 0, 0, img.width * 1, img.height * 1);
    }
...
function redBottom () {
    ...
    ctx.fillRect(img.width * 0, img.width * 0.6, img.width * 1, img.height * 0.3);
}
...
function redRight() {
    ...
    ctx.fillRect(img.width * 0.8, img.height * 0, img.width * 0.2, img.height * 1);
}
