...
cp node_modules/bootstrap/dist/fonts/glyphicons-halflings-regular.ttf/vendors;
...
cp node_modules/ng-file-upload/dist/ng-file-upload.min.js/vendors;
cp node_modules/ng-file-upload/dist/ng-file-upload-shim.min.js/vendors;
